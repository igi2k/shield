...
openssl req -new -x509 -days 1024 -key ${ca_key_file} -out ${ca_cert_file} 
...
openssl x509 -req -days 365 -in ${server_csr_file} -CA ${ca_cert_file} -CAkey ${ca_key_file} -CAcreateserial -out ${server_cert_file}